...
Partial Class lapPembelian
    ...
    Private Sub InitializeComponent()
        ...
        Me.dasarComboBox.Items.AddRange(New Object() {"No Pembelian", "ID User", "ID Pemasok", "ID Barang"})
        ...
        Me.Label1.Text = "LAPORAN PENGEMBALIAN"
        '
        'dataDataGridView
        '
        ...
        Me.dataDataGridView.Size = New System.Drawing.Size(1196, 404)
        Me.dataDataGridView.TabIndex = 3
        '
        'Column1
        '
        Me.Column1.HeaderText = "No Pembelian"
